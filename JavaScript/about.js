// Array for the featured section on about page (expanded for responsive display)
let featured = [ 
...
function getFeaturedItemsToShow() {
    ...
    if (computerQuery.matches) {
        ...
        return 2; // For small screens (mobile)
    }
}
...
function openRecipeDetailPage(selectedRecipeID) {
    ...
    // Open the recipeDetail page (correct path from about page)
